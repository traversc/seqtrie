...
RadixForest_hamming_search <- function(xp, sequences, max_distance, nthreads, show_progress) {
    .Call(`_seqtrie_RadixForest_hamming_search`, xp, sequences, max_distance, nthreads, show_progress)
}

RadixForest_levenshtein_search <- function(xp, sequences, max_distance, nthreads, show_progress) {
    .Call(`_seqtrie_RadixForest_levenshtein_search`, xp, sequences, max_distance, nthreads, show_progress)
}
...
RadixTree_hamming_search <- function(xp, sequences, max_distance, cost_matrix, nthreads, show_progress) {
    .Call(`_seqtrie_RadixTree_hamming_search`, xp, sequences, max_distance, cost_matrix, nthreads, show_progress)
}

RadixTree_levenshtein_search <- function(xp, sequences, max_distance, cost_matrix, nthreads, show_progress) {
    .Call(`_seqtrie_RadixTree_levenshtein_search`, xp, sequences, max_distance, cost_matrix, nthreads, show_progress)
}

RadixTree_anchored_search <- function(xp, sequences, max_distance, cost_matrix, nthreads, show_progress) {
    .Call(`_seqtrie_RadixTree_anchored_search`, xp, sequences, max_distance, cost_matrix, nthreads, show_progress)
}
...
c_dist_matrix <- function(query, target, mode = "levenshtein", cost_matrix = NULL, nthreads = 1L, show_progress = FALSE) {
    .Call(`_seqtrie_c_dist_matrix`, query, target, mode, cost_matrix, nthreads, show_progress)
}

c_dist_pairwise <- function(query, target, mode = "levenshtein", cost_matrix = NULL, nthreads = 1L, show_progress = FALSE) {
    .Call(`_seqtrie_c_dist_pairwise`, query, target, mode, cost_matrix, nthreads, show_progress)
}
